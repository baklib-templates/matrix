  ...
  var require_tiny_slider = __commonJS({
    "node_modules/tiny-slider/dist/tiny-slider.js"(exports) {
      ...
      var tns2 = function(options2) {
        ...
        if (responsive) {
          if (0 in responsive) {
            options2 = extend2(options2, responsive[0]);
            delete responsive[0];
          }
          var responsiveTem = {};
        ...
        function resizeTasks(e) {
          ...
          if (bpChanged) {
            ...
            if (autoplayButton && autoplayText !== autoplayTextTem) {
              var i = autoplay ? 1 : 0, html2 = autoplayButton.innerHTML, len = html2.length - autoplayTextTem[i].length;
              if (html2.substring(len) === autoplayTextTem[i]) {
                autoplayButton.innerHTML = html2.substring(0, len) + autoplayText[i];
              }
            }
          } else {
        ...
        return {
          ...
          destroy,
          rebuild: function() {
            return tns2(extend2(options2, optionsElements));
          }
        };
      };
      exports.tns = tns2;
